    <div class="container mx-auto mt-9 px-4 py-8 align-self-center">
        <div class="max-w-md mx-auto bg-gray-200 rounded-xl shadow-lg p-6">
            <h1 class="text-2xl font-bold mb-6 text-center">Paiement Woyofal</h1>
            ...
            <form method="POST" action="valider-achat" class="space-y-4">
                <div>
                    ...
                    <input 
                        ...
                        value="<?= isset($_POST['telephone']) ? htmlspecialchars($_POST['numero_compteur']) : '' ?>"
                    >
                    <?php if (isset($_SESSION['errors']['numero_compteur'])): ?>
                        <p class="text-red-500 text-sm mt-1"><?= $_SESSION['errors']['numero_compteur'] ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    >
                    <?php if (isset($_SESSION['errors']['montant'])): ?>
                        <p class="text-red-500 text-sm mt-1"><?= $_SESSION['errors']['montant'] ?></p>
                    <?php endif; ?>
                </div>
